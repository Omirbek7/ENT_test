const questions = [
    ...
    {
        question: "Где расселялись монгольские племена в ХІ-ХІІ вв.?",
        options: ["В верховьях Енисея", "На Орхоне и Керулене", "В долине Хуанхе", "В низовьях Волги", "В Семиречье"],
        correctAnswer: "На Орхоне и Керулене",
      },
      // 26
      {
        question: "Какая территория вошла в состав улуса Угедея?",
        options: ["Поволжье", "Северо-восточная часть Семиречья", "Центральный Казахстан", "Мавераннахр", "Южный Казахстан"],
        correctAnswer: "Северо-восточная часть Семиречья",
      },
      // 27
      {
        question: "Какое народное восстание против монгольского ига в первой половине ХІII века вы знаете?",
        options: ["Восстание Фархада в Сарае", "Восстание Хайдара в Ташкенте", "Восстание Мухамеда в Сыгнаке", "Восстание Тараби в Бухаре", "Восстание Ахмеда в Отраре"],
        correctAnswer: "Восстание Ахмеда в Отраре",
      },
      // 28
      {
        question: "Назовите дату начала завоевания монголами Казахстана",
        options: ["1155", "1219", "1211", "1222", "1216"],
        correctAnswer: "1219",
      },
      // 29
      {
        question: "Кому из сыновей Чингисхана достались в удел степи Сары-Арки?",
        options: ["Чагатаю", "Батыю", "Джучи", "Тулую", "Угэдэю"],
        correctAnswer: "Джучи",
      },
      // 30
      {
        question: "При каком хане в первой половине XIV века золотая орда достигла наибольшего могущества",
        options: ["Бату", "Узбек", "Джучи", "Урус", "Ерзен"],
        correctAnswer: "Узбек",
      },
      // 31
      {
        question: "Кто возглавлял монгольские войска, вторгшиеся в восточную Европу",
        options: ["Тулуй", "Угэдэй", "Бату", "Джучи", "Чагатай"],
        correctAnswer: "Бату",
      },
      // 32
      {
        question: "При каком хане ислам был объявлен гос религией в золотой орде",
        options: ["При Батые", "При Берке", "При Узбеке", "При Тохтамыше", "При Джанибеке"],
        correctAnswer: "При Узбеке",
      },
      // 33
      {
        question: "Кто из средневековых историков писал о монгольских завоеваниях",
        options: ["Кашгари", "Бируни", "Аль-Фараби", "Плано Карпини", "Махмуд бен Вали"],
        correctAnswer: "Плано Карпини",
      },
      // 34
      {
        question: "Как назывался высший совещательный орган в монгольской империи",
        options: ["Той", "Курултай", "Диван", "Парламент", "Вече"],
        correctAnswer: "Курултай",
      } // 35
  ];
